...
public class EnvConfig extends Properties
{
	...
	public EnvConfig()
	{
		try
		{
			...
			grid = System.getProperty(GRID_PROPERTY, DEFAULT_GRID_PROPERTY);
			
			gridHostName = System.getProperty(GRIDHOSTNAME_PROPERTY, DEFAULT_GRIDHOSTNAME);
			
			browserConfigFile = browser + ".properties";

			testConfigPath = "src/test/drivers/environments/" + testEnvironment + "/test-config.properties";

			FileInputStream fileInputStream = new FileInputStream(testConfigPath);
			load(fileInputStream);

			FileInputStream browserPropertiesStream = new FileInputStream("src/test/drivers/driverProperties/" + browserConfigFile);
	...
	public static final String GRID_PROPERTY = "grid";
	...
	public static final String DEFAULT_GRID_PROPERTY = "false";
